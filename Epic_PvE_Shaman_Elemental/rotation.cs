...
private static string InvigoratingHealingPotion_ItemName()
{
    switch (Language)
    {
        ...
        private static string EarthShock_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Earthquake_SpellName()
        {
            switch (Language)
            {
        ...
        private static string EchoingShock_SpellName()
        {
            switch (Language)
            {
        ...
        private static string FireElemental_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Icefury_SpellName()
        {
            switch (Language)
            {
        ...
        private static string LavaBeam_SpellName()
        {
            switch (Language)
            {
        ...
        private static string LiquidMagmaTotem_SpellName()
        {
            switch (Language)
            {
        ...
        private static string StaticDischarge_SpellName()
        {
            switch (Language)
            {
        ...
        private static string StormElemental_SpellName()
        {
            switch (Language)
            {
        ...
        private static string EarthShield_SpellName()//974
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Erdschild";
                case "Español":
                    return "Escudo de tierra";
                case "Français":
                    return "Bouclier de terre";
                case "Italiano":
                    return "Scudo di Terra";
                case "Português Brasileiro":
                    return "Escudo da Terra";
                case "Русский":
                    return "Щит земли";
                case "한국어":
                    return "대지의 보호막";
        ...
        private static string ThunderstrikeWard_SpellName()//462757
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Donnerschlagschutz";
                case "Español":
                    return "Resguardo de impacto de trueno";
                case "Français":
                    return "Protection du frappe-tonnerre";
                case "Italiano":
                    return "Protezione di Tuonassalto";
                case "Português Brasileiro":
                    return "Proteção Golpe Trovejante";
                case "Русский":
                    return "Оберег громового удара";
                case "한국어":
                    return "천둥의 일격 수호물";
                case "简体中文":
                    return "雷霆打击结界";
                default:
                    return "Thunderstrike Ward";
            }
        }
        private static string LiquidMgmaTotem_SpellName()//192222
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Totem des flüssigen Magmas";
                case "Español":
                    return "Tótem de Magma líquido";
                case "Français":
                    return "Totem de magma liquide";
                case "Italiano":
                    return "Totem del Magma Liquido";
                case "Português Brasileiro":
                    return "Totem de Magma Líquido";
                case "Русский":
                    return "Тотем жидкой магмы";
                case "한국어":
                    return "마그마 토템";
                case "简体中文":
                    return "岩浆图腾";
                default:
                    return "Liquid Magma Totem";
            }
        }
        private static string HealingSurge_SpellName()//8004
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Heilende Woge";
                case "Español":
                    return "Oleada de sanación";
                case "Français":
                    return "Afflux de soins";
                case "Italiano":
                    return "Eruzione Benefica";
                case "Português Brasileiro":
                    return "Maré Curativa";
                case "Русский":
                    return "Исцеляющий всплеск";
                case "한국어":
                    return "치유의 파도";
                case "简体中文":
                    return "治疗之涌";
        ...
        private static string AncestralSwiftness_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Schnelligkeit der Ahnen";
        case "Español":
            return "Presteza ancestral";
        case "Français":
            return "Rapidité ancestrale";
        case "Italiano":
            return "Rapidità Ancestrale";
        case "Português Brasileiro":
            return "Rapidez Ancestral";
        case "Русский":
            return "Стремительность предков";
        case "한국어":
            return "선조의 신속함";
        case "简体中文":
            return "先祖迅捷";
        ...
        private static string AncestralSpirit_SpellName()//2008
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Geist der Ahnen";
                case "Español":
                    return "Espíritu ancestral";
                case "Français":
                    return "Esprit ancestral";
                case "Italiano":
                    return "Spirito Ancestrale";
                case "Português Brasileiro":
...
private static string StoneBulwarkTotem_SpellName()
{
    switch (Language)
    {
        ...
        private static string EarthgrabTotem_SpellName()
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Totem des Erdgriffs";
                case "Español":
                    return "Tótem Pillaterra";
                case "Français":
                    return "Totem de poigne de terre";
                case "Italiano":
                    return "Totem della Presa della Terra";
                case "Português Brasileiro":
                    return "Totem Agarraterra";
                case "Русский":
                    return "Тотем хватки земли";
                case "한국어":
                    return "구속의 토템";
                case "简体中文":
                    return "陷地图腾";
                default:
                    return "Earthgrab Totem";
            }
        }
private static string DemonicHealthstone_ItemlName()
{
    ...
    private static string DrumsofDeathlyFerocity_BloodlustEffectName()
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Elemental Shaman", Color.Purple);
            ...
            //SpellCasts.Add(324386,VesperTotem_SpellName(Language)); //324386
            //SpellCasts.Add(328923,FaeTransfusion_SpellName(Language)); //328923
            //SpellCasts.Add(320674,ChainHarvest_SpellName(Language)); //320674
            ...
            SpellCasts.Add(318038,FlametongueWeapon_SpellName()); //318038
            ...
            SpellCasts.Add(454015,LightningBolt_SpellName()); //454015
            ...
            SpellCasts.Add(114050,Ascendance_SpellName()); //114050
            SpellCasts.Add(51886,CleanseSpirit_SpellName()); //51886
            SpellCasts.Add(8042,EarthShock_SpellName()); //8042
            SpellCasts.Add(61882,Earthquake_SpellName()); //61882
            SpellCasts.Add(320125,EchoingShock_SpellName()); //320125
            SpellCasts.Add(117014,ElementalBlast_SpellName()); //117014
            SpellCasts.Add(198067,FireElemental_SpellName()); //198067
            SpellCasts.Add(210714,Icefury_SpellName()); //210714
            SpellCasts.Add(114074,LavaBeam_SpellName()); //114074
            SpellCasts.Add(51505,LavaBurst_SpellName()); //51505 231721
            //SpellCasts.Add(117588,Meteor_SpellName()); //117588
            SpellCasts.Add(79206,SpiritwalkersGrace_SpellName()); //79206
            SpellCasts.Add(342243,StaticDischarge_SpellName()); //342243
            SpellCasts.Add(192249,StormElemental_SpellName()); //192249
            SpellCasts.Add(191634,Stormkeeper_SpellName()); //191634
            SpellCasts.Add(452201,Tempest_SpellName()); //452201
            SpellCasts.Add(51490,Thunderstorm_SpellName()); //51490
            SpellCasts.Add(108285,TotemicRecall_SpellName()); //108285
            ...
            SpellCasts.Add(462757,ThunderstrikeWard_SpellName());//462757
            SpellCasts.Add(192222,LiquidMgmaTotem_SpellName());//192222
            SpellCasts.Add(8004,HealingSurge_SpellName());//8004
            //SpellCasts.Add(2825,Bloodlust_SpellName());//2825
            SpellCasts.Add(2008,AncestralSpirit_SpellName());//2008
            ...
            //SpellCasts.Add(443454, AncestralSwiftness_SpellName());//443454
            ...
            MacroCasts.Add(1, "TopTrinket");
            MacroCasts.Add(2, "BottomTrinket");
            MacroCasts.Add(462620, "EarthquakeTarget");
            MacroCasts.Add(443454, "P_"+AncestralSwiftness_SpellName());
            ...
            CursorQueues = new List<string>(){
                ...
                Earthquake_SpellName(),
                WindRushTotem_SpellName(),
                LiquidMagmaTotem_SpellName(),
            ...
            PlayerQueues = new List<string>(){
                ...
                FireElemental_SpellName(),
                StormElemental_SpellName(),
                Stormkeeper_SpellName(),
                TotemicRecall_SpellName(),
                WindRushTotem_SpellName(),
                LiquidMagmaTotem_SpellName(),
                Earthquake_SpellName(),
                AncestralSwiftness_SpellName(),
                StoneBulwarkTotem_SpellName(),
                Thunderstorm_SpellName(),
                EarthgrabTotem_SpellName()
            ...
            TargetQueues = new List<string>(){
                ...
                ChainLightning_SpellName(),
                FlameShock_SpellName(),
                LightningLasso_SpellName(),
                EarthShock_SpellName(),
                LavaBeam_SpellName(),
                LavaBurst_SpellName(),
                Tempest_SpellName(),
