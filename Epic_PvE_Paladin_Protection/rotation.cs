...
///<summary>spell=274738</summary>
        ...
        private static string ArdentDefender_SpellName()
        {
            switch (Language)
            {
        ...
        ///<summary>spell=231665</summary>31935
        ...
        private static string BastionOfLight_SpellName()
        {
            switch (Language)
            {
        ...
        private static string BlessedHammer_SpellName()
        {
            switch (Language)
            {
        ...
        private static string CrusaderAura_SpellName()
        {
            switch (Language)
            {
        ...
        private static string DevotionAura_SpellName()
        {
            switch (Language)
            {
        ...
        private static string GuardianOfAncientKings_SpellName()
        {
            switch (Language)
            {
        ...
        ///<summary>spell=317854 53595</summary>
        private static string HammerOfTheRighteous_SpellName()
        {
            switch (Language)
            {
        ...
        ///<summary>spell=20271</summary>275779
        ...
        private static string MomentOfGlory_SpellName()
        {
            switch (Language)
            {
        ...
        private static string RetributionAura_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Sentinel_SpellName()
        {
            switch (Language)
            {
        ...
        private static string ShieldOfTheRighteous_SpellName()
        {
            switch (Language)
            {
        ...
        private static string HandOfReckoning_SpellName()//62124
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Hand der Abrechnung";
                case "Español":
                    return "Mano de juicio";
                case "Français":
                    return "Main de rétribution";
                case "Italiano":
                    return "Imposizione della Sfida";
                case "Português Brasileiro":
                    return "Ato de Bravura";
                case "Русский":
                    return "Длань расплаты";
                case "한국어":
                    return "집행의 손길";
                case "简体中文":
                    return "清算之手";
        ...
        private static string ConcentrationAura_SpellName()//317920
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Aura der Konzentration";
                case "Español":
                    return "Aura de concentración";
                case "Français":
                    return "Aura de concentration";
                case "Italiano":
                    return "Aura della Concentrazione";
                case "Português Brasileiro":
                    return "Aura de Concentração";
                case "Русский":
                    return "Аура сосредоточенности";
                case "한국어":
                    return "집중의 오라";
                case "简体中文":
                    return "专注光环";
        ...
        private static string ExecutionSentence_SpellName()//343527
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Todesurteil";
                case "Español":
                    return "Sentencia de ejecución";
                case "Français":
                    return "Condamnation à mort";
                case "Italiano":
                    return "Sentenza d'Esecuzione";
                case "Português Brasileiro":
                    return "Pena de Morte";
                case "Русский":
                    return "Смертный приговор";
                case "한국어":
                    return "사형 선고";
                case "简体中文":
                    return "处决宣判";
        ...
        private static string BladeofJustice_SpellName()//184575
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Klinge der Gerechtigkeit";
                case "Español":
                    return "Hoja de justicia";
                case "Français":
                    return "Lame de justice";
                case "Italiano":
                    return "Lama della Giustizia";
                case "Português Brasileiro":
                    return "Lâmina da Justiça";
                case "Русский":
                    return "Клинок справедливости";
                case "한국어":
                    return "심판의 칼날";
                case "简体中文":
                    return "公正之剑";
        ...
        private static string HolyBulwark_SpellName()
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Heiliges Bollwerk";
                case "Español":
                    return "Baluarte Sagrado";
                case "Français":
                    return "Rempart sacré";
                case "Italiano":
                    return "Baluardo Sacro";
                case "Português Brasileiro":
                    return "Baluarte Sagrado";
                case "Русский":
                    return "Святой оплот";
        ...
        private static string SacredWeapon_SpellName()
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Heilige Waffe";
                case "Español":
                    return "Arma sacra";
                case "Français":
                    return "Arme sacrée";
...
private static string BlessingOfSpellwarding_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Segen des Zauberschutzes";
        case "Español":
            return "Bendición de resguardo contra hechizos";
        case "Français":
            return "Bénédiction de protection des sorts";
        case "Italiano":
            return "Benedizione della Protezione Magica";
        case "Português Brasileiro":
            return "Bênção de Proteção Mágica";
        case "Русский":
            return "Благословение защиты от заклинаний";
        case "한국어":
            return "주문 수호의 축복";
        case "简体中文":
            return "破咒祝福";
        default:
            return "Blessing of Spellwarding";
    }
}
...
private static string FaithintheLight_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Vertrauen in das Licht";
        case "Español":
            return "Fe en la Luz";
        case "Français":
            return "Foi en la Lumière";
        case "Italiano":
            return "Fede nella Luce";
        case "Português Brasileiro":
            return "Fé na Luz";
        case "Русский":
            return "Вера в Свет";
        ...
        case "简体中文":
            return "信仰圣光";
        default:
            return "Faith in the Light";
    }
}

private static string RiteofSanctification_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Ritus der Heiligung";
        case "Español":
            return "Rito de santificación";
        case "Français":
            return "Rite de sanctification";
        case "Italiano":
            return "Rito della Santificazione";
        case "Português Brasileiro":
            return "Rito da Santificação";
        case "Русский":
            return "Обряд освящения";
        case "한국어":
            return "축성의 의식";
        case "简体中文":
            return "圣言祭礼";
        default:
            return "Rite of Sanctification";
    }
}
...
private static string RiteofAdjuration_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Ritus der Vereidigung";
        case "Español":
            return "Rito de ruego";
        case "Français":
            return "Rite de supplication";
        case "Italiano":
            return "Rito del Giuramento";
        case "Português Brasileiro":
            return "Rito da Adjuração";
        case "Русский":
            return "Обряд клятвы";
        case "한국어":
            return "서원의 의식";
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Protection Paladin", Color.Purple);
            ...
            //SpellCasts.Add(SpellId, Example_SpellName());
                SpellCasts.Add(53600 , ShieldOfTheRighteous_SpellName());//53600
                SpellCasts.Add(31884 , AvengingWrath_SpellName());//384376 31884
                SpellCasts.Add(86659 , GuardianOfAncientKings_SpellName());//86659
                SpellCasts.Add(212641 , GuardianOfAncientKings_SpellName());//212641
                SpellCasts.Add(31850 , ArdentDefender_SpellName());//31850
                SpellCasts.Add(327193 , MomentOfGlory_SpellName());//327193
                SpellCasts.Add(96231 , Rebuke_SpellName());//96231
                SpellCasts.Add(378974 , BastionOfLight_SpellName());//378974
                SpellCasts.Add(389539 , Sentinel_SpellName());//389539
                ...
                SpellCasts.Add(62124 , HandOfReckoning_SpellName());//62124
                SpellCasts.Add(275779 , Judgment_SpellName());//20271
                ...
                SpellCasts.Add(10326 , TurnEvil_SpellName());//10326
                SpellCasts.Add(465 , DevotionAura_SpellName());//465
                SpellCasts.Add(183435 , RetributionAura_SpellName());//183435
                SpellCasts.Add(328557 , CrusaderAura_SpellName());//328557
                SpellCasts.Add(317920 , ConcentrationAura_SpellName());//317920
                SpellCasts.Add(31935 , AvengersShield_SpellName());//231665
                SpellCasts.Add(204019 , BlessedHammer_SpellName());//204019
                SpellCasts.Add(375576 , DivineToll_SpellName());//375576
                SpellCasts.Add(427453 , EyeOfTyr_SpellName());//387174 316958 427453
                SpellCasts.Add(387174 , EyeOfTyr_SpellName());//387174 316958 427453
                SpellCasts.Add(53595 , HammerOfTheRighteous_SpellName());//317854 53595
                ...
                SpellCasts.Add(432459 , HolyBulwark_SpellName());//432459
                SpellCasts.Add(432472 , SacredWeapon_SpellName());//432472
                SpellCasts.Add(498 , DivineProtection_SpellName());//498
                SpellCasts.Add(204018 , BlessingOfSpellwarding_SpellName());//204018
                SpellCasts.Add(433568 , RiteofSanctification_SpellName());//433568
                SpellCasts.Add(433583 , RiteofAdjuration_SpellName());//433583
            ...
            MacroCasts.Add(2, "BottomTrinket");
             ...
             Macros.Add("TestConsecration", "/cast [@player] Consecration");
            ...
            MouseoverQueues = new List<string>(){
                ...
                HandOfReckoning_SpellName(),
                AvengersShield_SpellName(),
                BlessingOfProtection_SpellName(),
                BlessingOfSpellwarding_SpellName()
            ...
            TargetQueues = new List<string>(){
                ...
                ShieldOfTheRighteous_SpellName(),
                Rebuke_SpellName(),
