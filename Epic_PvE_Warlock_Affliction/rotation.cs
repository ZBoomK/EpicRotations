        ...
        private static string InvigoratingHealingPotion_ItemName()
{
    switch (Language)
    {
      ...
      ///<summary>spell=980</summary>
        private static string Agony_SpellName()
        {
            switch (Language)
            {
        ...
        private static string DarkSoul_Misery_SpellName()
        {
            switch (Language)
            {
        ...
        private static string DrainSoul_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Haunt_SpellName()
        {
            switch (Language)
            {
        ...
        private static string MaleficRapture_SpellName()
        {
            switch (Language)
            {
        ...
        private static string PhantomSingularity_SpellName()
        {
            switch (Language)
            {
        ...
        private static string SeedOfCorruption_SpellName()
        {
            switch (Language)
            {
        ...
        private static string SiphonLife_SpellName()
        {
            switch (Language)
            {
        ...
        private static string SoulSwap_SpellName()
        {
            switch (Language)
            {
        ...
        private static string SoulTap_SpellName()
        {
            switch (Language)
            {
        ...
        private static string SummonDarkglare_SpellName()
        {
            switch (Language)
            {
        ...
        private static string SummonSteward_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Demonbolt_SpellName()
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Dämonenblitz";
                case "Español":
                    return "Descarga de demonio";
                case "Français":
                    return "Trait démoniaque";
                case "Italiano":
                    return "Dardo Demoniaco";
                case "Português Brasileiro":
                    return "Seta Demoníaca";
                case "Русский":
                    return "Демонический заряд";
                case "한국어":
                    return "악마 화살";
                case "简体中文":
                    return "恶魔之箭";
        ...
        private static string UnstableAffliction_SpellName()
        {
            switch (Language)
            {
        ...
        private static string VileTaint_SpellName()
        {
            switch (Language)
            {
...
private static string Soulstone_SpellName()
{
    ...
    private static string DrumsofDeathlyFerocity_BloodlustEffectName()
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Affliction Warlock", Color.Purple);
            ...
            //Pair ids with casts
                ...
                SpellCasts.Add(386997 , SoulRot_SpellName()); //325640, 386997
                ...
                //SpellCasts.Add(199890 , CurseOfTongues_SpellName()); //1714, 199890
                ...
                SpellCasts.Add(980 , Agony_SpellName()); //980
                SpellCasts.Add(113860 , DarkSoul_Misery_SpellName()); //113860
                SpellCasts.Add(198590 , DrainSoul_SpellName()); //198590
                SpellCasts.Add(108503 , GrimoireOfSacrifice_SpellName()); //108503
                SpellCasts.Add(48181 , Haunt_SpellName()); //48181
                SpellCasts.Add(324536 , MaleficRapture_SpellName()); //324536
                SpellCasts.Add(205179 , PhantomSingularity_SpellName()); //205179
                SpellCasts.Add(27243 , SeedOfCorruption_SpellName()); //27243
                SpellCasts.Add(63106 , SiphonLife_SpellName()); //63106
                SpellCasts.Add(386951 , SoulSwap_SpellName()); //386951
                SpellCasts.Add(387118 , SoulTap_SpellName()); //387118
                SpellCasts.Add(205180 , SummonDarkglare_SpellName()); //205180
                SpellCasts.Add(316099 , UnstableAffliction_SpellName()); //316099
                SpellCasts.Add(278350 , VileTaint_SpellName()); //278350
                SpellCasts.Add(264178 , Demonbolt_SpellName()); //264178
                SpellCasts.Add(366222 , "CustomPet"); //366222
                SpellCasts.Add(691 , "CustomPet"); //691
            ...
            MouseoverQueues = new List<string>(){
                ...
                CurseOfExhaustion_SpellName(),
                CurseOfTongues_SpellName(),
            ...
            TargetQueues = new List<string>(){
                ...
                SpellLock_SpellName(),
                CurseOfExhaustion_SpellName(),
                CurseOfWeakness_SpellName(),
                DrainLife_SpellName(),
                Fear_SpellName(),
                ShadowBolt_SpellName(),
                SingeMagic_SpellName(),
                //Seduction_SpellName(),
                SeedOfCorruption_SpellName (),        
            };
