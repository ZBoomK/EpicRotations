...
///<summary>spell=131894</summary>
        ...
        private static string AspectOfTheEagle_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Butchery_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Carve_SpellName()
        {
            switch (Language)
            {
        ...
        private static string ConcussiveShot_SpellName()
        {
            switch (Language)
            {
        ...
        private static string CoordinatedAssault_SpellName()
        {
            switch (Language)
            {
        ...
        private static string FlankingStrike_SpellName()
        {
            switch (Language)
            {
        ...
        private static string FuryOfTheEagle_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Harpoon_SpellName()
        {
            switch (Language)
            {
        ...
        private static string MongooseBite_SpellName()
        {
            switch (Language)
            {
        ...
        private static string PheromoneBomb_SpellName()
        {
            switch (Language)
            {
        ...
        private static string RaptorStrike_SpellName()
        {
            switch (Language)
            {
        ...
        private static string ShrapnelBomb_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Spearhead_SpellName()
        {
            switch (Language)
            {
        ...
        private static string VipersVenom_SpellName()
        {
            switch (Language)
            {
        ...
        private static string VolatileBomb_SpellName()
        {
            switch (Language)
            {
        ...
        private static string WildfireBomb_SpellName()
        {
            switch (Language)
            {
...
private static string DemonicHealthstone_ItemlName()
{
    ...
    private static string DrumsofDeathlyFerocity_BloodlustEffectName()
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Survival Hunter", Color.Purple);
            ...
            //SpellCasts.Add(SpellId, Example_SpellName());
                ...
                SpellCasts.Add(257620, Multishot_SpellName()); //257620
                ...
                SpellCasts.Add(185358, ArcaneShot_SpellName());//185358
                SpellCasts.Add(186265, AspectOfTheTurtle_SpellName());//186265
                SpellCasts.Add(5116, ConcussiveShot_SpellName()); //5116
                ...
                SpellCasts.Add(187707, Muzzle_SpellName()); //187707
                SpellCasts.Add(186289, AspectOfTheEagle_SpellName()); //186289
                SpellCasts.Add(212436, Butchery_SpellName()); //212436
                SpellCasts.Add(187708, Carve_SpellName()); //187708
                SpellCasts.Add(360952, CoordinatedAssault_SpellName()); //360952
                SpellCasts.Add(269751, FlankingStrike_SpellName()); //269751
                SpellCasts.Add(203415, FuryOfTheEagle_SpellName()); //203415
                SpellCasts.Add(190925, Harpoon_SpellName()); //190925
                SpellCasts.Add(259489, KillCommand_SpellName()); //259489
                SpellCasts.Add(259387, MongooseBite_SpellName()); //259387
                SpellCasts.Add(270323, PheromoneBomb_SpellName()); //270323
                SpellCasts.Add(186270, RaptorStrike_SpellName()); //186270
                SpellCasts.Add(270335, ShrapnelBomb_SpellName()); //270335
                SpellCasts.Add(360966, Spearhead_SpellName()); //360966
                SpellCasts.Add(271045, VolatileBomb_SpellName()); //271045
                SpellCasts.Add(259495, WildfireBomb_SpellName()); //259495
            ...
            MouseoverQueues = new List<string>(){
                ...
                //WildSpirits_SpellName(),
                //ResonatingArrow_SpellName(),
                ...
                Muzzle_SpellName(),
                Harpoon_SpellName(),
                FlankingStrike_SpellName(),
                CoordinatedAssault_SpellName(),                
            ...
            TargetQueues = new List<string>(){
                ...
                TranquilizingShot_SpellName(),
                WailingArrow_SpellName(),
                ConcussiveShot_SpellName(),
                Butchery_SpellName(),
                Carve_SpellName(),
                KillCommand_SpellName(),
