...
private static string InvigoratingHealingPotion_ItemName()
{
    switch (Language)
    {
        ...
        private static string Annihilation_SpellName()
        {
            switch (Language)
            {
        ...
        private static string BladeDance_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Blur_SpellName()
        {
            switch (Language)
            {
        ...
        private static string ChaosStrike_SpellName()
        {
            switch (Language)
            {
        ...
        private static string CollectiveAnguish_SpellName()
        {
            switch (Language)
            {
        ...
        private static string ConsumeMagic_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Darkness_SpellName()
        {
            switch (Language)
            {
        ...
        private static string DeathSweep_SpellName()
        {
            switch (Language)
            {
        ...
        private static string DemonsBite_SpellName()
        {
            switch (Language)
            {
        ...
        private static string ElysianDecree_SpellName()
        {
            switch (Language)
            {
        ...
        private static string EssenceBreak_SpellName()
        {
            switch (Language)
            {
        ...
        private static string EyeBeam_SpellName()
        {
            switch (Language)
            {
        ...
        private static string FelBarrage_SpellName()
        {
            switch (Language)
            {
        ...
        private static string FelRush_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Felblade_SpellName()
        {
            switch (Language)
            {
        ...
        private static string FodderToTheFlame_SpellName()
        {
            switch (Language)
            {
        ...
        private static string GlaiveTempest_SpellName()
        {
            switch (Language)
            {
        ...
        private static string ImmolationAura_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Netherwalk_SpellName()
        {
            switch (Language)
            {
        ...
        private static string SigilOfFlame_SpellName()
        {
            switch (Language)
            {
        ...
        private static string SigilOfMisery_SpellName()
        {
            switch (Language)
            {
        ...
        private static string SinfulBrand_SpellName()
        {
            switch (Language)
            {
...
private static string SigilofSpite_SpellName()
{
    switch (Language)
    {
        ...
        private static string TheHunt_SpellName()
        {
            switch (Language)
            {
        ...
        private static string ThrowGlaive_SpellName()
        {
            switch (Language)
            {
                ...
                private static string AzeriteSurge_SpellName()
{
    switch (Language)
    {
        ...
        private static string VengefulRetreat_SpellName()
        {
            switch (Language)
            {
...
private static string CosmicAscension_NPCName()
{
    ...
    private static string AbyssalGaze_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Abyssischer Blick";
        case "Español":
            return "Mirada abisal";
        case "Français":
            return "Regard abyssal";
        case "Italiano":
            return "Sguardo Abissale";
        case "Português Brasileiro":
            return "Mirada Abissal";
        case "Русский":
            return "Взор глубин";
        case "한국어":
            return "심연의 응시";
...
private static string DemonicHealthstone_ItemlName()
{
    ...
    private static string DrumsofDeathlyFerocity_BloodlustEffectName()
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Havoc DemonHunter", Color.Purple);
            ...
            //SpellCasts.Add(SpellId, Example_SpellName());
                ...
                SpellCasts.Add(329554 , FodderToTheFlame_SpellName()); //329554
                SpellCasts.Add(370965 , TheHunt_SpellName()); //370965
                SpellCasts.Add(317009 , SinfulBrand_SpellName()); //317009
                SpellCasts.Add(183752 , Disrupt_SpellName()); //183752
                SpellCasts.Add(201427 , Annihilation_SpellName()); //201427
                SpellCasts.Add(188499 , BladeDance_SpellName()); //188499
                SpellCasts.Add(198589 , Blur_SpellName()); //198589
                SpellCasts.Add(179057 , ChaosNova_SpellName()); //179057
                SpellCasts.Add(162794 , ChaosStrike_SpellName()); //162794
                SpellCasts.Add(390152 , CollectiveAnguish_SpellName()); //390152
                SpellCasts.Add(278326 , ConsumeMagic_SpellName()); //278326
                SpellCasts.Add(196718 , Darkness_SpellName()); //196718
                SpellCasts.Add(210152 , DeathSweep_SpellName()); //210152
                SpellCasts.Add(162243 , DemonsBite_SpellName()); //162243
                SpellCasts.Add(258860 , EssenceBreak_SpellName()); //258860
                SpellCasts.Add(198013 , EyeBeam_SpellName()); //198013
                SpellCasts.Add(258925 , FelBarrage_SpellName()); //258925
                SpellCasts.Add(211881 , FelEruption_SpellName()); //211881
                SpellCasts.Add(195072 , FelRush_SpellName()); //195072
                SpellCasts.Add(232893 , Felblade_SpellName()); //232893
                SpellCasts.Add(342817 , GlaiveTempest_SpellName()); //342817
                ...
                SpellCasts.Add(196555 , Netherwalk_SpellName()); //196555
                SpellCasts.Add(204596 , SigilOfFlame_SpellName()); //204596
                SpellCasts.Add(207684 , SigilOfMisery_SpellName()); //207684
                ...
                SpellCasts.Add(452497 , AbyssalGaze_SpellName()); //452497
            ...
            PlayerQueues = new List<string>(){
                ...
                Blur_SpellName(),
                FelRush_SpellName(),
                Netherwalk_SpellName(),
                SigilofDoom_SpellName(),
                ArcaneTorrent_SpellName(),
