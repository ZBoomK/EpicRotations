...
private static string InvigoratingHealingPotion_ItemName()
{
    switch (Language)
    {
        ...
        private static string AlgariHealingPotion_SpellName()
        {
         ...
         ///<summary>spell=325733 391888</summary>
        ...
        private static string BrutalSlash_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Dash_SpellName()
        {
            switch (Language)
            {
        ...
        private static string FeralFrenzy_SpellName()
        {
            switch (Language)
            {
        ...
        private static string FerociousBite_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Incarnation_AvatarOfAshamane_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Maim_SpellName()
        {
            switch (Language)
            {
        ...
        private static string PredatorySwiftness_SpellName()
        {
            switch (Language)
            {
        ...
        private static string PrimalWrath_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Prowl_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Shred_SpellName()
        {
            switch (Language)
            {
        ...
        private static string TigerDash_SpellName()
        {
            switch (Language)
            {
        ...
        private static string TigersFury_SpellName()
        {
            switch (Language)
            {
        ...
        private static string WildCharge_SpellName()
        {
            switch (Language)
            {
...
private static string FlightForm_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Fluggestalt";
        case "Español":
            return "Forma de vuelo";
        case "Français":
            return "Forme de vol";
        case "Italiano":
            return "Forma Volante";
        case "Português Brasileiro":
            return "Forma Voadora";
        case "Русский":
            return "Облик птицы";
        case "한국어":
            return "폭풍날개 변신";
...
private static string AzeriteSurge_SpellName()
{
    switch (Language)
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Feral Druid", Color.Purple);
            ...
            //SpellCasts.Add(SpellId, Example_SpellName());
                SpellCasts.Add(391528 , ConvokeTheSpirits_SpellName());//391528
                SpellCasts.Add(323764 , ConvokeTheSpirits_SpellName());//323764
                SpellCasts.Add(391888 , AdaptiveSwarm_SpellName());//325733 391888
                ...
                SpellCasts.Add(202028 , BrutalSlash_SpellName()); //202028
                SpellCasts.Add(768 , CatForm_SpellName());//768
                SpellCasts.Add(274837 , FeralFrenzy_SpellName()); //274837
                SpellCasts.Add(22658 , FerociousBite_SpellName()); //22658
                SpellCasts.Add(319454 , HeartOfTheWild_SpellName());//319454
                SpellCasts.Add(102543 , Incarnation_AvatarOfAshamane_SpellName()); //102543
                SpellCasts.Add(22570 , Maim_SpellName()); //22570
                ...
                SpellCasts.Add(285381 , PrimalWrath_SpellName()); //285381
                SpellCasts.Add(5215 , Prowl_SpellName()); //5215
                ...
                SpellCasts.Add(5221 , Shred_SpellName()); //5221
                SpellCasts.Add(2908 , Soothe_SpellName());//2908
                SpellCasts.Add(78674 , Starsurge_SpellName());//78674
                SpellCasts.Add(164815 , Sunfire_SpellName());//164815
                SpellCasts.Add(61336 , SurvivalInstincts_SpellName()); //61336
                SpellCasts.Add(106785 , Swipe_SpellName()); //106785
                SpellCasts.Add(106830 , Thrash_SpellName()); //106830
                SpellCasts.Add(252216 , TigerDash_SpellName()); //252216
                SpellCasts.Add(5217 , TigersFury_SpellName()); //5217
                SpellCasts.Add(102401 , WildCharge_SpellName()); //102401
                SpellCasts.Add(22568 , FerociousBite_SpellName()); //102401 22568
                SpellCasts.Add(441591 , Ravage_SpellName());//441591
                SpellCasts.Add(155625 , Moonfire_SpellName());//441591
                SpellCasts.Add(123456 , FrenziedRegeneration_SpellName());
            ...
            MouseoverQueues = new List<string>(){
                SkullBash_SpellName(),
                Maim_SpellName(),
                MassEntanglement_SpellName(),
                MightyBash_SpellName(),
                Rake_SpellName(),
                Regrowth_SpellName(),
                RemoveCorruption_SpellName(),
                Soothe_SpellName(),
                WildCharge_SpellName(),
                Rebirth_SpellName()
            ...
            PlayerQueues = new List<string>(){
                ...
                AdaptiveSwarm_SpellName(),
                Barkskin_SpellName(),
                HeartOfTheWild_SpellName(),
                Incarnation_AvatarOfAshamane_SpellName(),
                NaturesVigil_SpellName(),
                Regrowth_SpellName(),
                RemoveCorruption_SpellName(),
            ...
            TargetQueues = new List<string>(){
                SkullBash_SpellName(),
                BrutalSlash_SpellName(),
                FerociousBite_SpellName(),
                Maim_SpellName(),
                MightyBash_SpellName(),
                Rake_SpellName(),
                RemoveCorruption_SpellName(),
