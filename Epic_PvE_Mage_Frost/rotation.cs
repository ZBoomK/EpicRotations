        ...
        private static string InvigoratingHealingPotion_ItemName()
{
    switch (Language)
    {
        ...
        private static string AlterTime_SpellName()
        {
            switch (Language)
            {
        ...
        private static string ArcaneExplosion_SpellName()
        {
            switch (Language)
            {
        ...
        private static string ArcaneIntellect_SpellName()
        {
            switch (Language)
            {
        ...
        private static string BlastWave_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Blink_SpellName()
        {
            switch (Language)
            {
        ...
        ///<summary>spell=190356</summary>
        private static string Blizzard_SpellName()
        {
            switch (Language)
            {
                case "English": return "Blizzard";
                case "Deutsch": return "Blizzard";
                case "Español": return "Ventisca";
                case "Français": return "Blizzard";
                case "Italiano": return "Tormenta";
                case "Português Brasileiro": return "Nevasca";
                case "Русский": return "Снежная буря";
                case "한국어": return "눈보라";
                case "简体中文": return "暴风雪";
        ...
        ///<summary>spell=235219</summary>
        private static string ColdSnap_SpellName()
        {
            switch (Language)
            {
                case "English": return "Cold Snap";
                case "Deutsch": return "Kälteeinbruch";
                case "Español": return "Mordedura de frío";
                case "Français": return "Frimaire";
                case "Italiano": return "Prontezza Gelida";
                case "Português Brasileiro": return "Ruptura do Gelo";
                case "Русский": return "Холодная хватка";
                case "한국어": return "매서운 한파";
                case "简体中文": return "急速冷却";
                default: return "Cold Snap";
            }
        }

        ///<summary>spell=153595</summary>
        private static string CometStorm_SpellName()
        {
            switch (Language)
            {
                case "English": return "Comet Storm";
                case "Deutsch": return "Kometenhagel";
                case "Español": return "Lluvia de cometas";
                case "Français": return "Tempête de comètes";
                case "Italiano": return "Tempesta di Comete";
                case "Português Brasileiro": return "Chuva de Cometas";
                case "Русский": return "Кометная буря";
                case "한국어": return "혜성 폭풍";
                case "简体中文": return "彗星风暴";
                default: return "Comet Storm";
            }
        }

        ///<summary>spell=120</summary>
        private static string ConeOfCold_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Deathborne_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Displacement_SpellName()
        {
            switch (Language)
            {
        ...
        private static string DragonsBreath_SpellName()
        {
            switch (Language)
            {
        ...
        ///<summary>spell=257537</summary>
        private static string Ebonbolt_SpellName()
        {
            switch (Language)
            {
                case "English": return "Ebonbolt";
                case "Deutsch": return "Schwarzblitz";
                case "Español": return "Descarga de ébano";
                case "Français": return "Éclair d’ébène";
                case "Italiano": return "Dardo d'Ebano";
                case "Português Brasileiro": return "Seta de Ébano";
                case "Русский": return "Полярная стрела";
                case "한국어": return "칠흑화살";
                case "简体中文": return "黑冰箭";
                default: return "Ebonbolt";
            }
        }
        ...
        private static string FireBlast_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Flurry_SpellName()
        {
            switch (Language)
            {
        ...
        private static string FocusMagic_SpellName()
        {
            switch (Language)
            {
        ...
        private static string FrostNova_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Frostbolt_SpellName()
        {
            switch (Language)
            {
        ...
        ///<summary>spell=198149</summary>
        private static string FrozenOrb_SpellName()
        {
            switch (Language)
            {
                case "English": return "Frozen Orb";
                case "Deutsch": return "Gefrorene Kugel";
                case "Español": return "Orbe congelado";
                case "Français": return "Orbe gelé";
                case "Italiano": return "Globo Congelato";
                case "Português Brasileiro": return "Orbe Congelado";
                case "Русский": return "Ледяной шар";
                case "한국어": return "얼어붙은 구슬";
                case "简体中文": return "寒冰宝珠";
                default: return "Frozen Orb";
            }
        }
        ...
        ///<summary>spell=199786</summary>
        private static string GlacialSpike_SpellName()
        {
            switch (Language)
            {
                case "English": return "Glacial Spike";
                case "Deutsch": return "Gletscherstachel";
                case "Español": return "Pica glacial";
                case "Français": return "Pointe glaciaire";
                case "Italiano": return "Aculeo Glaciale";
                case "Português Brasileiro": return "Punhal Glacial";
                case "Русский": return "Ледовый шип";
                case "한국어": return "혹한의 쐐기";
                case "简体中文": return "冰川尖刺";
                default: return "Glacial Spike";
            }
        }

        ///<summary>spell=110959</summary>
        private static string GreaterInvisibility_SpellName()
        {
            switch (Language)
            {
        ...
        ///<summary>spell=11426</summary>
        private static string IceBarrier_SpellName()
        {
            switch (Language)
            {
                case "English": return "Ice Barrier";
                case "Deutsch": return "Eisbarriere";
                case "Español": return "Barrera de hielo";
                case "Français": return "Barrière de glace";
                case "Italiano": return "Barriera di Ghiaccio";
                case "Português Brasileiro": return "Barreira de Gelo";
                case "Русский": return "Ледяная преграда";
                case "한국어": return "얼음 보호막";
                case "简体中文": return "寒冰护体";
                default: return "Ice Barrier";
            }
        }

        ///<summary>spell=45438</summary>
        private static string IceBlock_SpellName()
        {
            switch (Language)
            {
        ...
        private static string IceFloes_SpellName()
        {
            switch (Language)
            {
        ...
        ///<summary>spell=30455</summary>
        private static string IceLance_SpellName()
        {
            switch (Language)
            {
                case "English": return "Ice Lance";
                case "Deutsch": return "Eislanze";
                case "Español": return "Lanza de hielo";
                case "Français": return "Javelot de glace";
                case "Italiano": return "Lancia di Ghiaccio";
                case "Português Brasileiro": return "Lança de Gelo";
                case "Русский": return "Ледяное копье";
                case "한국어": return "얼음창";
                case "简体中文": return "冰枪术";
                default: return "Ice Lance";
            }
        }

        ///<summary>spell=157997</summary>
        private static string IceNova_SpellName()
        {
            switch (Language)
            {
        ...
        ///<summary>spell=12472</summary>
        private static string IcyVeins_SpellName()
        {
            switch (Language)
            {
                case "English": return "Icy Veins";
                case "Deutsch": return "Eisige Adern";
                case "Español": return "Venas heladas";
                case "Français": return "Veines glaciales";
                case "Italiano": return "Vene Gelide";
                case "Português Brasileiro": return "Veias Gélidas";
                case "Русский": return "Стылая кровь";
                case "한국어": return "얼음 핏줄";
                case "简体中文": return "冰冷血脉";
                default: return "Icy Veins";
            }
        }

        ///<summary>spell=66</summary>
        private static string Invisibility_SpellName()
        {
            switch (Language)
            {
        ...
        private static string MassPolymorph_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Meteor_SpellName()
        {
            switch (Language)
            {
        ...
        private static string MirrorImage_SpellName()
        {
            switch (Language)
            {
        ...
        private static string MirrorsOfTorment_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Polymorph_SpellName()
        {
            switch (Language)
            {
        ...
        private static string RadiantSpark_SpellName()
        {
            switch (Language)
            {
        ...
        ///<summary>spell=205021</summary>
        private static string RayOfFrost_SpellName()
        {
            switch (Language)
            {
                case "English": return "Ray of Frost";
                case "Deutsch": return "Froststrahl";
                case "Español": return "Rayo de Escarcha";
                case "Français": return "Rayon de givre";
                case "Italiano": return "Raggio di Gelo";
                case "Português Brasileiro": return "Raio de Gelo";
                case "Русский": return "Морозный луч";
                case "한국어": return "서리 광선";
                case "简体中文": return "冰霜射线";
                default: return "Ray of Frost";
            }
        }
        ...
        private static string RemoveCurse_SpellName()
        {
            switch (Language)
            {
        ...
        private static string RingOfFrost_SpellName()
        {
            switch (Language)
            {
        ...
        private static string RuneOfPower_SpellName()
        {
            switch (Language)
            {
        ...
        private static string ShiftingPower_SpellName()
        {
            switch (Language)
            {
        ...
        private static string SlowFall_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Spellsteal_SpellName()
        {
            switch (Language)
            {
        ...
        ///<summary>spell=31687</summary>
        private static string SummonWaterElemental_SpellName()
        {
            switch (Language)
            {
                case "English": return "Summon Water Elemental";
                case "Deutsch": return "Wasserelementar beschwören";
                case "Español": return "Invocar elemental de agua";
                case "Français": return "Invocation d'un élémentaire d'eau";
                case "Italiano": return "Evocazione: Elementale dell'Acqua";
                case "Português Brasileiro": return "Evocar Elemental da Água";
                case "Русский": return "Призыв элементаля воды";
                case "한국어": return "물의 정령 소환";
                case "简体中文": return "召唤水元素";
                default: return "Summon Water Elemental";
            }
        }
        ...
        private static string Torment_SpellName()
        {
            switch (Language)
            {
        ...
        private static string FrostFireBolt_SpellName()
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Frostfeuerblitz";
                case "Español":
                    return "Descarga de Pirofrío";
                case "Français":
                    return "Éclair de givrefeu";
                case "Italiano":
                    return "Palla di Fuocogelo";
                case "Português Brasileiro":
                    return "Seta de Fogofrio";
                case "Русский":
                    return "Стрела ледяного огня";
                case "한국어":
                    return "얼음불꽃 화살";
                case "简体中文":
                    return "霜火之箭";
                default:
                    return "Frostfire Bolt";
            }
        }
...
private static string IceCold_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
        ...
        case "Español":
            return "Frío polar";
        case "Français":
            return "Un froid glacial";
        case "Italiano":
            return "Freddo Come il Ghiaccio";
        case "Português Brasileiro":
            return "Frio Enregelante";
        case "Русский":
            return "Ледяной холод";
        case "한국어":
            return "얼음장";
        case "简体中文":
            return "深寒凝冰";
...
private static string MassBarrier_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Massenbarriere";
        case "Español":
            return "Barrera en masa";
        case "Français":
            return "Barrière de masse";
        case "Italiano":
            return "Barriera di Massa";
        case "Português Brasileiro":
            return "Barreira Maciça";
        case "Русский":
            return "Массовая преграда";
        case "한국어":
            return "대규모 방벽";
        case "简体中文":
            return "群体屏障";
...
private static string FrostfireEmpowerment_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Frostfeuerermächtigung";
        case "Español":
            return "Potenciación de Pirofrío";
        case "Français":
            return "Renforcement de givrefeu";
        case "Italiano":
            return "Potenziamento di Fuocogelo";
        case "Português Brasileiro":
            return "Potencialização de Fogofrio";
        case "Русский":
            return "Усиление ледяного огня";
        case "한국어":
            return "서리불꽃 강화";
        case "简体中文":
            return "霜火增效";
        default:
            return "Frostfire Empowerment";
    }
}
private static string WintersChill_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Winterkälte";
        case "Español":
            return "Escalofrío invernal";
        case "Français":
            return "Froid de l'hiver";
        case "Italiano":
            return "Gelo Invernale";
        case "Português Brasileiro":
            return "Calafrio do Inverno";
        case "Русский":
            return "Зимняя стужа";
        case "한국어":
            return "혹한의 추위";
        case "简体中文":
            return "深冬之寒";
        default:
            return "Winter's Chill";
    }
}
private static string Shimmer_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
    ...
    private static string DrumsofDeathlyFerocity_BloodlustEffectName()
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Frost Mage", Color.Purple);
            ...
            //Pair ids with casts
                //SpellCasts.Add(307443 , RadiantSpark_SpellName()); //307443
                //SpellCasts.Add(324220 , Deathborne_SpellName()); //324220
                SpellCasts.Add(382440 , ShiftingPower_SpellName()); //314791 382440
                SpellCasts.Add(314793 , MirrorsOfTorment_SpellName()); //314793
                SpellCasts.Add(2139 , Counterspell_SpellName()); //2139
                SpellCasts.Add(342245 , AlterTime_SpellName()); //342245
                SpellCasts.Add(1449 , ArcaneExplosion_SpellName()); //1449
                SpellCasts.Add(1459 , ArcaneIntellect_SpellName()); //1459
                SpellCasts.Add(157981 , BlastWave_SpellName()); //157981
                SpellCasts.Add(212653 , Blink_SpellName());//53 or 212653
                SpellCasts.Add(120 , ConeOfCold_SpellName()); //120
                SpellCasts.Add(389713 , Displacement_SpellName()); //389713
                SpellCasts.Add(31661 , DragonsBreath_SpellName()); //31661
                SpellCasts.Add(108853 , FireBlast_SpellName()); //108853
                SpellCasts.Add(122 , FrostNova_SpellName()); //122
                SpellCasts.Add(116 , Frostbolt_SpellName()); //116
                SpellCasts.Add(110959 , GreaterInvisibility_SpellName()); //110959
                SpellCasts.Add(11426 , IceBarrier_SpellName()); //11426
                SpellCasts.Add(45438 , IceBlock_SpellName()); //45438
                SpellCasts.Add(108839 , IceFloes_SpellName()); //108839
                SpellCasts.Add(157997 , IceNova_SpellName()); //157997
                SpellCasts.Add(66 , Invisibility_SpellName()); //66
                SpellCasts.Add(383121 , MassPolymorph_SpellName()); //383121
                SpellCasts.Add(153561 , Meteor_SpellName()); //153561
                SpellCasts.Add(55342 , MirrorImage_SpellName()); //55342
                SpellCasts.Add(118 , Polymorph_SpellName()); //118
                SpellCasts.Add(475 , RemoveCurse_SpellName()); //475
                SpellCasts.Add(113724 , RingOfFrost_SpellName()); //113724
                SpellCasts.Add(116011 , RuneOfPower_SpellName()); //116011
                SpellCasts.Add(130 , SlowFall_SpellName()); //130
                SpellCasts.Add(30449 , Spellsteal_SpellName()); //30449
                SpellCasts.Add(80353 , TimeWarp_SpellName()); //80353
                SpellCasts.Add(190356 , Blizzard_SpellName()); //190356
                SpellCasts.Add(235219 , ColdSnap_SpellName()); //235219
                SpellCasts.Add(153595 , CometStorm_SpellName()); //153595
                SpellCasts.Add(257537 , Ebonbolt_SpellName()); //257537
                SpellCasts.Add(44614 , Flurry_SpellName()); //44614
                SpellCasts.Add(321358 , FocusMagic_SpellName()); //321358
                SpellCasts.Add(84714 , FrozenOrb_SpellName()); //198149 84714
                SpellCasts.Add(199786 , GlacialSpike_SpellName()); //199786
                SpellCasts.Add(30455 , IceLance_SpellName()); //30455
    
                SpellCasts.Add(12472 , IcyVeins_SpellName()); //12472
                SpellCasts.Add(205021 , RayOfFrost_SpellName()); //205021
                SpellCasts.Add(31687 , SummonWaterElemental_SpellName()); //31687
                SpellCasts.Add(431044 , FrostFireBolt_SpellName()); //431044
                SpellCasts.Add(26297 , Berserking_SpellName()); //26297
                SpellCasts.Add(33395 , Freeze_SpellName()); //33395
            ...
            MouseoverQueues = new List<string>(){
                MassPolymorph_SpellName(),
                Polymorph_SpellName(),
                RemoveCurse_SpellName(),
                Counterspell_SpellName()

            };
            CursorQueues = new List<string>(){
                Meteor_SpellName(),
                RingOfFrost_SpellName(),
                Blizzard_SpellName(),
                FrozenOrb_SpellName(),
            };
            PlayerQueues = new List<string>(){
                ShiftingPower_SpellName(),
                AlterTime_SpellName(),
                ArcaneIntellect_SpellName(),
                Blink_SpellName(),
                ConeOfCold_SpellName(),
                FrostNova_SpellName(),
                GreaterInvisibility_SpellName(),
                IceBarrier_SpellName(),
                IceBlock_SpellName(),
                Invisibility_SpellName(),
                Meteor_SpellName(),
                MirrorImage_SpellName(),
                IceCold_SpellName(),
                DragonsBreath_SpellName(),
                BlastWave_SpellName(),
                MassBarrier_SpellName(),
                Shimmer_SpellName()
            };
