        ...
        private static string InvigoratingHealingPotion_ItemName()
{
    switch (Language)
    {
        ...
        private static string BlazingBarrier_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Combustion_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Evocation_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Fireball_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Flamestrike_SpellName()
        {
            switch (Language)
            {
        ...
        ///<summary>spell=48108</summary>
        private static string HotStreaki_SpellName()
        {
            switch (Language)
            {
                case "English": return "Hot Streak!";
                case "Deutsch": return "Kampfeshitze!";
                case "Español": return "¡Buena racha!";
                case "Français": return "Bonne série !";
                case "Italiano": return "Serie Bollente";
                case "Português Brasileiro": return "Embalo de Fogo!";
                case "Русский": return "Полоса везения";
                case "한국어": return "몰아치는 열기!";
                case "简体中文": return "炽热连击！";
                default: return "Hot Streak!";
            }
        }
        ...
        private static string LivingBomb_SpellName()
        {
            switch (Language)
            {
        ...
        private static string PhoenixFlames_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Pyroblast_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Scorch_SpellName()
        {
            switch (Language)
            {
...
private static string DemonicHealthstone_ItemlName()
{
    ...
    private static string DrumsofDeathlyFerocity_BloodlustEffectName()
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Fire Mage", Color.Purple);
            ...
            //Pair ids with casts
                ...
                SpellCasts.Add(235313 , BlazingBarrier_SpellName()); //235313
                SpellCasts.Add(157981 , BlastWave_SpellName()); //157981
                SpellCasts.Add(212653 , Blink_SpellName()); //1953 or 212653
                ...
                SpellCasts.Add(133 , Fireball_SpellName()); //133
                ...
                SpellCasts.Add(190319 , "NeuralSynapse"); //190319
                SpellCasts.Add(2120 , Flamestrike_SpellName()); //2120
                SpellCasts.Add(321358 , FocusMagic_SpellName()); //321358
                SpellCasts.Add(44457 , LivingBomb_SpellName()); //44457
                SpellCasts.Add(257541 , PhoenixFlames_SpellName()); //257541
                SpellCasts.Add(11366 , Pyroblast_SpellName()); //11366
                SpellCasts.Add(2948 , Scorch_SpellName()); //2948
                SpellCasts.Add(431044 , FrostFireBolt_SpellName()); //431044
                SpellCasts.Add(3 , "NeuralSynapse"); //431044
