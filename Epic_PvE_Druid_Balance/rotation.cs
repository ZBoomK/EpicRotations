...
private static string InvigoratingHealingPotion_ItemName()
{
    switch (Language)
    {
       ...
       ///<summary>spell=325733</summary>
        ...
        private static string AstralCommunion_SpellName()
        {
            switch (Language)
            {
        ...
        private static string CelestialAlignment_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Cyclone_SpellName()
        {
            switch (Language)
            {
        ...
        private static string EmpowerBond_SpellName()
        {
            switch (Language)
            {
        ...
        private static string ForceOfNature_SpellName()
        {
            switch (Language)
            {
        ...
        private static string FullMoon_SpellName()
        {
            switch (Language)
            {
        ...
        private static string FuryOfElune_SpellName()
        {
            switch (Language)
            {
        ...
        private static string HalfMoon_SpellName()
        {
            switch (Language)
            {
        ...
        ///<summary>spell=102560 390414</summary>
        private static string Incarnation_ChosenOfElune_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Innervate_SpellName()
        {
            switch (Language)
            {
        ...
        private static string MountForm_SpellName()
        {
            switch (Language)
            {
        ...
        private static string NewMoon_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Starfall_SpellName()
        {
            switch (Language)
            {
        ...
        private static string StellarFlare_SpellName()
        {
            switch (Language)
            {
        ...
        private static string WarriorOfElune_SpellName()
        {
            switch (Language)
            {
        ...
        private static string WildMushroom_SpellName()
        {
            switch (Language)
            {
        ...
        private static string OrbitalStrike_SpellName()
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Orbitalschlag";
                case "Español":
                    return "Golpe orbital";
                case "Français":
                    return "Frappe orbitale";
                case "Italiano":
                    return "Assalto Orbitale";
                case "Português Brasileiro":
                    return "Golpe Orbital";
                case "Русский":
                    return "Орбитальный удар";
                case "한국어":
                    return "활공의 일격";
                case "简体中文":
                    return "轨道打击";
                ...
                private static string AzeriteSurge_SpellName()
{
    switch (Language)
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Balance Druid", Color.Purple);
            ...
            //SpellCasts.Add(SpellId, Example_SpellName());
                ...
                SpellCasts.Add(391528, ConvokeTheSpirits_SpellName()); //323764 391528
                SpellCasts.Add(325727, AdaptiveSwarm_SpellName()); //325727
                SpellCasts.Add(106839, SkullBash_SpellName()); //106839
                SpellCasts.Add(78675, SolarBeam_SpellName()); //78675
                ...
                SpellCasts.Add(33786, Cyclone_SpellName()); //33786
                ...
                SpellCasts.Add(29166, Innervate_SpellName()); //29166
                SpellCasts.Add(1126, MarkOfTheWild_SpellName()); //1126
                SpellCasts.Add(102359, MassEntanglement_SpellName()); //102359
                ...
                SpellCasts.Add(194153, Starfire_SpellName()); //194153
                SpellCasts.Add(93402, Sunfire_SpellName()); //93402
                SpellCasts.Add(132469, Typhoon_SpellName()); //132469
                SpellCasts.Add(190984, Wrath_SpellName()); //190984
                SpellCasts.Add(202359, AstralCommunion_SpellName()); //202359
                SpellCasts.Add(194223, CelestialAlignment_SpellName()); //194223 
                SpellCasts.Add(383410, CelestialAlignment_SpellName()); //383410 
                SpellCasts.Add(205636, ForceOfNature_SpellName()); //205636
                SpellCasts.Add(202770, FuryOfElune_SpellName()); //202770
                SpellCasts.Add(102560, Incarnation_ChosenOfElune_SpellName()); //102560
                SpellCasts.Add(390414, Incarnation_ChosenOfElune_SpellName()); //390414
                SpellCasts.Add(24858, MoonkinForm_SpellName()); //24858
                SpellCasts.Add(191034, Starfall_SpellName()); //191034
                SpellCasts.Add(78674, Starsurge_SpellName()); //78674
                SpellCasts.Add(202347, StellarFlare_SpellName()); //202347
                SpellCasts.Add(102793, UrsolsVortex_SpellName()); //102793
                SpellCasts.Add(202425, WarriorOfElune_SpellName()); //202425
                SpellCasts.Add(88747, WildMushroom_SpellName()); //88747
                SpellCasts.Add(274281, NewMoon_SpellName()); //274281
                SpellCasts.Add(274282, HalfMoon_SpellName()); //274282
                SpellCasts.Add(274283, FullMoon_SpellName()); //274283
                SpellCasts.Add(390378, OrbitalStrike_SpellName()); //390378
            ...
            MouseoverQueues = new List<string>(){
                Rebirth_SpellName(),
                Regrowth_SpellName(),
                ForceOfNature_SpellName(),
                StellarFlare_SpellName(),
                Innervate_SpellName(),
            ...
            CursorQueues = new List<string>(){
                ...
                OrbitalStrike_SpellName(),
                ForceOfNature_SpellName(),
                CelestialAlignment_SpellName(),
            ...
            PlayerQueues = new List<string>(){
                ...
                Typhoon_SpellName(),
                CelestialAlignment_SpellName(),
                Incarnation_ChosenOfElune_SpellName(),
                MarkOfTheWild_SpellName(),
                MoonkinForm_SpellName(),
