        ...
        private static string InvigoratingHealingPotion_ItemName()
{
  ...
  ///<summary>spell=342245</summary>
        ...
        ///<summary>spell=44425</summary>
        private static string ArcaneBarrage_SpellName()
        {
            switch (Language)
            {
                case "English": return "Arcane Barrage";
                case "Deutsch": return "Arkanbeschuss";
                case "Español": return "Tromba Arcana";
                case "Français": return "Barrage des Arcanes";
                case "Italiano": return "Sbarramento Arcano";
                case "Português Brasileiro": return "Salva Arcana";
                case "Русский": return "Чародейский обстрел";
                case "한국어": return "비전 탄막";
                case "简体中文": return "奥术弹幕";
                default: return "Arcane Barrage";
            }
        }

        ///<summary>spell=30451</summary>
        private static string ArcaneBlast_SpellName()
        {
            switch (Language)
            {
                case "English": return "Arcane Blast";
                case "Deutsch": return "Arkanschlag";
                case "Español": return "Explosión Arcana";
                case "Français": return "Déflagration des Arcanes";
                case "Italiano": return "Detonazione Arcana";
                case "Português Brasileiro": return "Impacto Arcano";
                case "Русский": return "Чародейская вспышка";
                case "한국어": return "비전 작렬";
                case "简体中文": return "奥术冲击";
                default: return "Arcane Blast";
            }
        }
        ...
        ///<summary>spell=205022</summary>
        private static string ArcaneFamiliar_SpellName()
        {
            switch (Language)
            {
                case "English": return "Arcane Familiar";
                case "Deutsch": return "Arkaner Familiar";
                case "Español": return "Familiar Arcano";
                case "Français": return "Familier arcanique";
                case "Italiano": return "Elmion Arcano";
                case "Português Brasileiro": return "Familiar Arcano";
                case "Русский": return "Волшебный фамилиар";
                case "한국어": return "비전 전령";
                case "简体中文": return "奥术魔宠";
                default: return "Arcane Familiar";
            }
        }
        ...
        ///<summary>spell=5143</summary>
        private static string ArcaneMissiles_SpellName()
        {
            switch (Language)
            {
                case "English": return "Arcane Missiles";
                case "Deutsch": return "Arkane Geschosse";
                case "Español": return "Misiles Arcanos";
                case "Français": return "Projectiles des Arcanes";
                case "Italiano": return "Missili Arcani";
                case "Português Brasileiro": return "Mísseis Arcanos";
                case "Русский": return "Чародейские стрелы";
                case "한국어": return "신비한 화살";
                case "简体中文": return "奥术飞弹";
                default: return "Arcane Missiles";
            }
        }

        ///<summary>spell=153626</summary>
        private static string ArcaneOrb_SpellName()
        {
            switch (Language)
            {
                case "English": return "Arcane Orb";
                case "Deutsch": return "Arkane Kugel";
                case "Español": return "Orbe Arcano";
                case "Français": return "Orbe arcanique";
                case "Italiano": return "Globo Arcano";
                case "Português Brasileiro": return "Orbe Arcano";
                case "Русский": return "Чародейский шар";
                case "한국어": return "비전 보주";
                case "简体中文": return "奥术宝珠";
        ...
        ///<summary>spell=365350</summary>
        private static string ArcaneSurge_SpellName()
        {
            switch (Language)
            {
                case "English": return "Arcane Surge";
                case "Deutsch": return "Arkane Woge";
                case "Español": return "Oleada Arcana";
                case "Français": return "Éruption d’arcanes";
                case "Italiano": return "Eruzione Arcana";
                case "Português Brasileiro": return "Surto Arcano";
                case "Русский": return "Чародейский выброс";
                case "한국어": return "비전 쇄도";
                case "简体中文": return "奥术涌动";
                default: return "Arcane Surge";
            }
        }
        ...
        ///<summary>spell=759</summary>
        private static string ConjureManaGem_SpellName()
        {
            switch (Language)
            {
                case "English": return "Conjure Mana Gem";
                case "Deutsch": return "Manaedelstein herbeizaubern";
                case "Español": return "Crear gema de maná";
                case "Français": return "Invocation d’une gemme de mana";
                case "Italiano": return "Evocazione Gemma di Mana";
                case "Português Brasileiro": return "Conjurar Gema de Mana";
                case "Русский": return "Сотворение самоцвета маны";
                case "한국어": return "마나석 창조";
                case "简体中文": return "制造法力宝石";
                default: return "Conjure Mana Gem";
            }
        }

        ///<summary>spell=190336</summary>
        private static string ConjureRefreshment_SpellName()
        {
            switch (Language)
            {
                case "English": return "Conjure Refreshment";
                case "Deutsch": return "Erfrischungen herbeizaubern";
                case "Español": return "Crear refrigerio";
                case "Français": return "Invocation de rafraîchissements";
                case "Italiano": return "Creazione Rinfresco";
                case "Português Brasileiro": return "Conjurar Refeição";
                case "Русский": return "Сотворение яств";
                case "한국어": return "원기 회복의 음식 창조";
                case "简体中文": return "造餐术";
                default: return "Conjure Refreshment";
            }
        }
        ...
        private static string ManaGem_SpellName()
        {
            switch (Language)
            {
        ...
        ///<summary>spell=114923</summary>
        private static string NetherTempest_SpellName()
        {
            switch (Language)
            {
                case "English": return "Nether Tempest";
                case "Deutsch": return "Netherorkan";
                case "Español": return "Tempestad abisal";
                case "Français": return "Tempête du Néant";
                case "Italiano": return "Tempesta Fatua";
                case "Português Brasileiro": return "Tempestade de Éter";
                case "Русский": return "Буря Пустоты";
                case "한국어": return "황천의 폭풍우";
                case "简体中文": return "虚空风暴";
                default: return "Nether Tempest";
            }
        }
        ...
        ///<summary>spell=205025</summary>
        private static string PresenceOfMind_SpellName()
        {
            switch (Language)
            {
                case "English": return "Presence of Mind";
                case "Deutsch": return "Geistesgegenwart";
                case "Español": return "Presencia mental";
                case "Français": return "Présence spirituelle";
                case "Italiano": return "Prontezza di Spirito";
                case "Português Brasileiro": return "Presença de Espírito";
                case "Русский": return "Величие разума";
                case "한국어": return "냉정";
                case "简体中文": return "气定神闲";
                default: return "Presence of Mind";
            }
        }
        ...
        ///<summary>spell=235450</summary>
        private static string PrismaticBarrier_SpellName()
        {
            switch (Language)
            {
                case "English": return "Prismatic Barrier";
                case "Deutsch": return "Prismatische Barriere";
                case "Español": return "Barrera prismática";
                case "Français": return "Barrière prismatique";
                case "Italiano": return "Barriera Prismatica";
                case "Português Brasileiro": return "Barreira Prismática";
                case "Русский": return "Призматический барьер";
                case "한국어": return "오색 방벽";
                case "简体中文": return "棱光护体";
                default: return "Prismatic Barrier";
            }
        }
        ...
        ///<summary>spell=382440 382440 </summary>
        ...
        ///<summary>spell=31589</summary>
        private static string Slow_SpellName()
        {
            switch (Language)
            {
                case "English": return "Slow";
                case "Deutsch": return "Verlangsamen";
                case "Español": return "Ralentizar";
                case "Français": return "Lenteur";
                case "Italiano": return "Rallentamento";
                case "Português Brasileiro": return "Retardar";
                case "Русский": return "Замедление";
                case "한국어": return "감속";
                case "简体中文": return "减速";
                default: return "Slow";
            }
        ...
        ///<summary>spell=157980</summary>
        private static string Supernova_SpellName()
        {
            switch (Language)
            {
                case "English": return "Supernova";
                case "Deutsch": return "Supernova";
                case "Español": return "Supernova";
                case "Français": return "Supernova";
                case "Italiano": return "Supernova";
                case "Português Brasileiro": return "Supernova";
                case "Русский": return "Сверхновая";
                case "한국어": return "초신성";
                case "简体中文": return "超级新星";
        ...
        ///<summary>spell=321507</summary>
        private static string TouchOfTheMagi_SpellName()
        {
            switch (Language)
            {
                case "English": return "Touch of the Magi";
                case "Deutsch": return "Berührung der Magi";
                case "Español": return "Toque de los magi";
                case "Français": return "Toucher des magi";
                case "Italiano": return "Tocco del Magus";
                case "Português Brasileiro": return "Toque dos Magos";
                case "Русский": return "Касание мага";
                case "한국어": return "비전의 여파";
                case "简体中文": return "大法师之触";
                default: return "Touch of the Magi";
            }
        }
...
private static string Shimmer_SpellName()
{
    ...
    private static string DrumsofDeathlyFerocity_BloodlustEffectName()
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Arcane Mage", Color.Purple);
            ...
            //Pair ids with casts
                ...
                SpellCasts.Add(44425 , ArcaneBarrage_SpellName()); //44425
                SpellCasts.Add(30451 , ArcaneBlast_SpellName()); //30451
                SpellCasts.Add(1449 , ArcaneExplosion_SpellName()); //1449
                SpellCasts.Add(205022 , ArcaneFamiliar_SpellName()); //205022
                SpellCasts.Add(1459 , ArcaneIntellect_SpellName()); //1459
                SpellCasts.Add(5143 , ArcaneMissiles_SpellName()); //5143
                SpellCasts.Add(153626 , ArcaneOrb_SpellName()); //153626
                SpellCasts.Add(365350 , ArcaneSurge_SpellName()); //365350
                SpellCasts.Add(342245 , AlterTime_SpellName()); //342245
                SpellCasts.Add(2126531 , Blink_SpellName()); //1953 or 212653
                SpellCasts.Add(157981 , BlastWave_SpellName()); //157981
                SpellCasts.Add(759 , ConjureManaGem_SpellName()); //759
                SpellCasts.Add(190336 , ConjureRefreshment_SpellName()); //190336
                ...
                SpellCasts.Add(12051 , Evocation_SpellName()); //12051
                SpellCasts.Add(319836 , FireBlast_SpellName()); //319836
                ...
                SpellCasts.Add(257997 , IceNova_SpellName()); //257997
                ...
                SpellCasts.Add(114923 , NetherTempest_SpellName()); //114923
                SpellCasts.Add(118 , Polymorph_SpellName()); //118
                SpellCasts.Add(205025 , PresenceOfMind_SpellName()); //205025
                SpellCasts.Add(235450 , PrismaticBarrier_SpellName()); //235450
                ...
                SpellCasts.Add(31589 , Slow_SpellName()); //31589
                SpellCasts.Add(130 , SlowFall_SpellName()); //130
                SpellCasts.Add(30449 , Spellsteal_SpellName()); //30449
                SpellCasts.Add(157980 , Supernova_SpellName()); //157980
                SpellCasts.Add(80353 , TimeWarp_SpellName()); //80353
                SpellCasts.Add(321507 , TouchOfTheMagi_SpellName()); //321507
                SpellCasts.Add(212653 , Shimmer_SpellName()); //212653
            ...
            PlayerQueues = new List<string>(){
                Blink_SpellName(),
                ConjureRefreshment_SpellName(),
                ConeOfCold_SpellName(),
                Evocation_SpellName(),
                FrostNova_SpellName(),
                IceBlock_SpellName(),
                Invisibility_SpellName(),
                PrismaticBarrier_SpellName(),
