    ...
    switch (Language)
    {
        ...
        private static string AlgariHealingPotion_SpellName()
        {
            switch (Language)
            {
                ...
                private static string AxeToss_SpellName()
        {
            switch (Language)
            {
                case "Deutsch":
                    return "Axtwurf";
                case "Español":
                    return "Lanzamiento de hachas";
                case "Français":
                    return "Lancer de hache";
                case "Italiano":
                    return "Lancio dell'Ascia";
                case "Português Brasileiro":
                    return "Arremesso de Machado";
                case "Русский":
                    return "Метание топора";
                case "한국어":
                    return "도끼 던지기";
                case "简体中文":
                    return "巨斧投掷";
        ...
        private static string BilescourgeBombers_SpellName()
        {
            switch (Language)
            {
        ...
        private static string BurningRush_SpellName()
        {
            switch (Language)
            {
        ...
        private static string CallDreadstalkers_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Demonbolt_SpellName()
        {
            switch (Language)
            {
        ...
        private static string DemonicStrength_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Doom_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Grimoire_Felguard_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Guillotine_SpellName()
        {
            switch (Language)
            {
        ...
        private static string HandOfGuldan_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Implosion_SpellName()
        {
            switch (Language)
            {
        ...
        private static string NetherPortal_SpellName()
        {
            switch (Language)
            {
        ...
        private static string PowerSiphon_SpellName()
        {
            switch (Language)
            {
        ...
        private static string SoulStrike_SpellName()
        {
            switch (Language)
            {
        ...
        private static string SummonDemonicTyrant_SpellName()
        {
            switch (Language)
            {
        ...
        private static string SummonVilefiend_SpellName()
        {
            switch (Language)
            {
        ...
        private static string SummonFelguard_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Teufelswache beschwören";
        case "Español":
            return "Invocar guardia vil";
        case "Français":
            return "Invocation de gangregarde";
        case "Italiano":
            return "Evocazione: Vilguardia";
        case "Português Brasileiro":
            return "Evocar Guarda Vil";
        case "Русский":
            return "Призыв стража Скверны";
        case "한국어":
            return "지옥수호병 소환";
        case "简体中文":
            return "召唤恶魔卫士";
...
private static string SummonCharhound_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Aschenhund beschwören";
        case "Español":
            return "Invocar sabueso calcinado";
        case "Français":
            return "Invocation d’un molosse embrasé";
        case "Italiano":
            return "Evocazione: Mastino Ardente";
        case "Português Brasileiro":
            return "Evocar Chamuscão";
        case "Русский":
            return "Призыв огнедышащей гончей";
        case "한국어":
            return "숯사냥개 소환";
        case "简体中文":
            return "召唤灼焦恶犬";
        default:
            return "Summon Charhound";
    }
}
...
private static string GloomHound_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Schattenhund beschwören";
        case "Español":
            return "Invocar can umbrío";
        case "Français":
            return "Invocation d’un molosse ombreux";
        case "Italiano":
            return "Evocazione: Mastino Tenebroso";
        case "Português Brasileiro":
            return "Evocar Canisvil das Trevas";
        case "Русский":
            return "Призыв сумеречной гончей";
        case "한국어":
            return "어스름사냥개 소환";
        case "简体中文":
            return "召唤阴暗恶犬";
        default:
            return "Summon Gloomhound";
    }
}
private static string SummonGloomhound_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
...
}private static string Soulstone_SpellName()
{
    ...
    private static string DrumsofDeathlyFerocity_BloodlustEffectName()
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Demonology Warlock", Color.Purple);
            ...
            //Pair ids with casts
                ...
                SpellCasts.Add(89766 , AxeToss_SpellName()); //89766
                ...
                SpellCasts.Add(267211 , BilescourgeBombers_SpellName()); //267211
                SpellCasts.Add(111400 , BurningRush_SpellName()); //111400
                SpellCasts.Add(104316 , CallDreadstalkers_SpellName()); //104316
                SpellCasts.Add(264178 , Demonbolt_SpellName()); //264178
                SpellCasts.Add(267171 , DemonicStrength_SpellName()); //267171
                SpellCasts.Add(603 , Doom_SpellName()); //603
                SpellCasts.Add(111898 , Grimoire_Felguard_SpellName()); //111898
                SpellCasts.Add(386833 , Guillotine_SpellName()); //386833
                SpellCasts.Add(105174 , HandOfGuldan_SpellName()); //105174
                SpellCasts.Add(196277 , Implosion_SpellName()); //196277
                //SpellCasts.Add(267217 , NetherPortal_SpellName()); //267217
                SpellCasts.Add(264130 , PowerSiphon_SpellName()); //264130
                SpellCasts.Add(264057 , SoulStrike_SpellName()); //264057
                SpellCasts.Add(265187 , SummonDemonicTyrant_SpellName()); //265187
                SpellCasts.Add(264119 , SummonVilefiend_SpellName()); //264119
                SpellCasts.Add(434635 , Ruination_SpellName()); //434635
                SpellCasts.Add(455476 , SummonCharhound_SpellName()); //455476
                SpellCasts.Add(366222 , "CustomPet"); //366222
                SpellCasts.Add(30146 , "CustomPet2"); //30146
                SpellCasts.Add(434506 , InfernalBolt_SpellName()); //434506 // can be shadow bolt
                SpellCasts.Add(455465 , SummonGloomhound_SpellName()); //455465
            ...
            MacroCasts.Add(2, "BottomTrinket");
             ...
             Macros.Add("implosion", "/stopcasting\\n/cast "+Implosion_SpellName()); 
            ...
            CursorQueues = new List<string>(){
                Guillotine_SpellName(),
                BilescourgeBombers_SpellName(),
            ...
            PlayerQueues = new List<string>(){
                ...
                SummonDemonicTyrant_SpellName(),
                SummonFelguard_SpellName(),
