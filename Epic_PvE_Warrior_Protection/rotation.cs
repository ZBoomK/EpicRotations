        ...
        private static string ThunderBlast_SpellName()
            {
                ...
                {
                    case "Deutsch":
                        return "Donnerexplosion";
                    case "Español":
                        return "Explosión de trueno";
                    case "Français":
                        return "Explosion de tonnerre";
                    case "Italiano":
                        return "Boato del Tuono";
                    case "Português Brasileiro":
                        return "Impacto Trovejante";
                    case "Русский":
                        return "Разряд грома";
                    case "한국어":
                        return "우레 작렬";
...
private static string SpellBlock_SpellName()
{
    switch (Language)
    {
        ...
        case "Français":
            return "Blocage de sorts";
        case "Italiano":
            return "Blocca Incantesimo";
        case "Português Brasileiro":
            return "Bloqueio de Feitiço";
        case "Русский":
            return "Блокирование заклинаний";
        case "한국어":
            return "주문 막기";
        case "简体中文":
            return "法术格挡";
...
private static string DisruptingShout_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Unterbrechender Schrei";
        case "Español":
            return "Grito perturbador";
        case "Français":
            return "Cri perturbant";
        case "Italiano":
            return "Urlo Distraente";
        case "Português Brasileiro":
            return "Brado Interruptivo";
        case "Русский":
            return "Разрушительный крик";
        case "한국어":
            return "훼방의 외침";
        case "简体中文":
            return "瓦解怒吼";
        default:
            return "Disrupting Shout";
    }
}
    ...
    private static string DrumsofDeathlyFerocity_BloodlustEffectName()
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Protection Warrior", Color.Purple);
            ...
            //SpellCasts.Add(SpellId, Example_SpellName());
                ...
                SpellCasts.Add(871 ,ShieldWall_SpellName());//871
                SpellCasts.Add(53478 ,LastStand_SpellName());//53478
                SpellCasts.Add(12975 ,LastStand_SpellName());//12975
                SpellCasts.Add(190456 ,IgnorePain_SpellName());//190456
                SpellCasts.Add(383762 ,BitterImmunity_SpellName());//383762
                SpellCasts.Add(401150 ,Avatar_SpellName());//401150
                ...
                SpellCasts.Add(97462 ,RallyingCry_SpellName());//97462
                ...
                SpellCasts.Add(281000 ,Execute_SpellName());//281000
                ...
                SpellCasts.Add(384090 ,TitanicThrow_SpellName());//384090
                SpellCasts.Add(384110 ,WreckingThrow_SpellName());//384110
                SpellCasts.Add(228920 ,Ravager_SpellName());//228920
                SpellCasts.Add(2565 ,ShieldBlock_SpellName());//2565
                SpellCasts.Add(23922 ,ShieldSlam_SpellName());//23922
                SpellCasts.Add(1160 ,DemoralizingShout_SpellName());//1160
                SpellCasts.Add(6572 ,Revenge_SpellName());//6572
                SpellCasts.Add(385952 ,ShieldCharge_SpellName());//385952
                SpellCasts.Add(436358, Demolish_SpellName());//436358
                SpellCasts.Add(435222, ThunderBlast_SpellName());//435222
                SpellCasts.Add(392966, SpellBlock_SpellName());//392966
                SpellCasts.Add(20572, BloodFury_SpellName());//392966
            ...
            PlayerQueues = new List<string>(){
                ...
                Ravager_SpellName(),
                LastStand_SpellName(),
                ShieldWall_SpellName(),
                IntimidatingShout_SpellName(),
                DisruptingShout_SpellName(),
                ChallengingShout_SpellName()
            };
