...
private static string InvigoratingHealingPotion_ItemName()
{
    switch (Language)
    {
        ...
        private static string BreathOfSindragosa_SpellName()
        {
            switch (Language)
            {
        ...
        private static string ChillStreak_SpellName()
        {
            switch (Language)
            {
...
private static string Frostbane_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Frostbann";
        case "Español":
            return "Perdición de Escarcha";
        case "Français":
            return "Fléau du givre";
        case "Italiano":
            return "Flagello del Gelo";
        case "Português Brasileiro":
            return "Perdição Gélida";
        case "Русский":
            return "Ледяная погибель";
        case "한국어":
            return "냉기파멸";
        case "简体中文":
            return "冰霜灾祸";
        ...
        private static string FrostStrike_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Frostscythe_SpellName()
        {
            switch (Language)
            {
        ...
        private static string FrostwyrmsFury_SpellName()
        {
            switch (Language)
            {
        ...
        private static string HornOfWinter_SpellName()
        {
            switch (Language)
            {
        ...
        private static string HowlingBlast_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Obliterate_SpellName()
        {
            switch (Language)
            {
        ...
        private static string PillarOfFrost_SpellName()
        {
            switch (Language)
            {
        ...
        private static string RemorselessWinter_SpellName()
        {
            switch (Language)
            {
...
private static string LegionofSouls_SpellName()
{
    ...
    private static string DrumsofDeathlyFerocity_BloodlustEffectName()
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Frost Deathknight", Color.Purple);
 ...
 //Pair ids with casts
            //SpellCasts.Add(SpellId, Example_SpellName());
                ...
                SpellCasts.Add(152279, BreathOfSindragosa_SpellName()); //152279
                SpellCasts.Add(1249658, BreathOfSindragosa_SpellName()); //1249658
                SpellCasts.Add(45524, ChainsOfIce_SpellName()); //45524
                SpellCasts.Add(305392, ChillStreak_SpellName()); //305392
                ...
                SpellCasts.Add(49143, FrostStrike_SpellName()); //49143
                SpellCasts.Add(207230, Frostscythe_SpellName()); //207230
                SpellCasts.Add(279302, FrostwyrmsFury_SpellName()); //279302
                SpellCasts.Add(194913, GlacialAdvance_SpellName()); //194913
                SpellCasts.Add(57330, HornOfWinter_SpellName()); //57330
                SpellCasts.Add(49184, HowlingBlast_SpellName()); //49184
                SpellCasts.Add(48792, IceboundFortitude_SpellName()); //48792
                SpellCasts.Add(49039, Lichborne_SpellName()); //49039
                SpellCasts.Add(49020, Obliterate_SpellName()); //49020
                SpellCasts.Add(51271, PillarOfFrost_SpellName()); //51271
                SpellCasts.Add(61999, RaiseAlly_SpellName()); //61999
                SpellCasts.Add(46585, RaiseDead_SpellName()); //46584 46585
                SpellCasts.Add(196770, RemorselessWinter_SpellName()); //196770
                ...
                SpellCasts.Add(1228433, Frostbane_SpellName()); //1228433
            ...
            TargetQueues = new List<string>(){
                ...
                DeathStrike_SpellName(),
                FrostStrike_SpellName(),
                Frostscythe_SpellName(),
                Obliterate_SpellName(),
                RaiseAlly_SpellName(),
