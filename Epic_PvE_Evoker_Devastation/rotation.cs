...
private static string InvigoratingHealingPotion_ItemName()
{
    switch (Language)
    {
        ...
        private static string Engulf_SpellName()
        {
            switch (Language)
            {
                case "Deutsch":
        ...
        ///<summary>spell=357210 433874</summary>
        ...
        private static string Firestorm_SpellName()
        {
            switch (Language)
            {
...
private static string BestinSlots_ItemName()
{
    ...
    private static string DrumsofDeathlyFerocity_BloodlustEffectName()
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Devastation Evoker", Color.Purple);
            ...
            //Pair ids with casts
                ...
                SpellCasts.Add(359073 , EternitySurge_SpellName()); //382411 359073
                SpellCasts.Add(382411  , EternitySurge_SpellName()); //382411 359073
                SpellCasts.Add(357211 , Pyre_SpellName()); //357211
                SpellCasts.Add(370452 , ShatteringStar_SpellName()); //370452
                SpellCasts.Add(433874 , DeepBreath_SpellName()); //357210
                SpellCasts.Add(357210 , DeepBreath_SpellName()); //357210
                SpellCasts.Add(368847 , Firestorm_SpellName()); //368847
                SpellCasts.Add(375087 , Dragonrage_SpellName()); //375087
                ...
                SpellCasts.Add(443328 , Engulf_SpellName()); //443328
