        ...
        private static string InvigoratingHealingPotion_ItemName()
{
    switch (Language)
    {
        ...
        ///<summary>spell=1680 190411</summary>
...
private static string ThunderBlast_SpellName()
{
    switch (Language)
    {
        ...
        private static string Bladestorm_SpellName() //227847 446035
        {
            switch (Language)
            {
                case "Deutsch":
...
private static string BestinSlots_ItemName()
{
    ...
    private static string DrumsofDeathlyFerocity_BloodlustEffectName()
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Fury Warrior", Color.Purple);
  ...
  //Pair ids with casts
            //SpellCasts.Add(SpellId, Example_SpellName());
                ...
                SpellCasts.Add(386196, BerserkerStance_SpellName());//386196
                SpellCasts.Add(383762, BitterImmunity_SpellName());//383762
                SpellCasts.Add(228920, Ravager_SpellName());//228920
                SpellCasts.Add(335096, Bloodbath_SpellName());//335096
                SpellCasts.Add(23881, Bloodthirst_SpellName());//23881
                SpellCasts.Add(1161, ChallengingShout_SpellName());//1161
                SpellCasts.Add(100, Charge_SpellName());//100
                SpellCasts.Add(335097, CrushingBlow_SpellName());//335097
                SpellCasts.Add(41101, DefensiveStance_SpellName());//41101
                SpellCasts.Add(184364, EnragedRegeneration_SpellName());//184364
                SpellCasts.Add(5308, Execute_SpellName());//5308),
                SpellCasts.Add(163201, Execute_SpellName());//163201),
                SpellCasts.Add(280735, Execute_SpellName());//280735),
                ...
                SpellCasts.Add(385059, OdynsFury_SpellName());//385059
                SpellCasts.Add(315720, Onslaught_SpellName());//315720
                ...
                SpellCasts.Add(184367, Rampage_SpellName());//184367
                SpellCasts.Add(1719, Recklessness_SpellName());//1719
                ...
                SpellCasts.Add(190411, Whirlwind_SpellName());//1680 190411
                ...
                SpellCasts.Add(6343, ThunderClap_SpellName());//6343 435222
