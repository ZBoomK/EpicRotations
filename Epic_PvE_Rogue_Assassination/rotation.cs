        ...
        private static string InvigoratingHealingPotion_ItemName()
{
    switch (Language)
    {
        ...
        private static string CrimsonTempest_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Deathmark_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Envenom_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Exsanguinate_SpellName()
        {
            switch (Language)
            {
        ...
        private static string IndiscriminateCarnage_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Kingsbane_SpellName()
        {
            switch (Language)
            {
        ...
        private static string PoisonedKnife_SpellName()
        {
            switch (Language)
            {
...
private static string DemonicHealthstone_ItemlName()
{
    ...
    private static string DrumsofDeathlyFerocity_BloodlustEffectName()
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Rogue Assassination", Color.Purple);
            ...
            //SpellCasts.Add(SpellId, Example_SpellName());
                ...
                SpellCasts.Add(382245, ColdBlood_SpellName()); //382245 456330
                ...
                SpellCasts.Add(121411, CrimsonTempest_SpellName()); //121411
                SpellCasts.Add(360194, Deathmark_SpellName()); //360194
                SpellCasts.Add(32645, Envenom_SpellName()); //32645
                SpellCasts.Add(200806, Exsanguinate_SpellName()); //200806
                SpellCasts.Add(51723, FanOfKnives_SpellName()); //51723
                SpellCasts.Add(703 , Garrote_SpellName()); //703
                SpellCasts.Add(381802, IndiscriminateCarnage_SpellName()); //381802
                SpellCasts.Add(385627, Kingsbane_SpellName()); // 385627
                SpellCasts.Add(1329, Mutilate_SpellName()); //1329
                SpellCasts.Add(185565, PoisonedKnife_SpellName()); //185565
                ...
                SpellCasts.Add(25046,ArcaneTorrent_SpellName());//25046
                SpellCasts.Add(26297,Berserking_SpellName());//26297
                SpellCasts.Add(265221,Fireblood_SpellName());//26297
