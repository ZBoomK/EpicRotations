...
private static string InvigoratingHealingPotion_ItemName()
{
    switch (Language)
    {
        ...
        private static string DeathsAdvance_SpellName()
        {
            switch (Language)
            {
        ...
        private static string VileContagion_SpellName()
        {
            switch (Language)
            {
        ...
        private static string RaiseAbomination_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Monstrosität erwecken";
        case "Español":
            return "Resucitar a abominación";
        case "Français":
            return "Résurrection d’abomination";
        case "Italiano":
            return "Rianimazione Abominio";
        case "Português Brasileiro":
            return "Erguer Abominação";
        case "Русский":
            return "Воскрешение поганища";
        case "한국어":
            return "누더기골렘 되살리기";
        case "简体中文":
            return "培育憎恶";
        default:
            return "Raise Abomination";
    }
}
...
private static string FesteringScythe_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
            return "Schwärende Sense";
        case "Español":
            return "Guadaña purulenta";
        case "Français":
            return "Faux purulente";
        case "Italiano":
            return "Falce Putrescente";
        case "Português Brasileiro":
            return "Foice Purulenta";
        case "Русский":
            return "Гнойная коса";
        case "한국어":
            return "부패의 낫";
...
private static string Cheating_SpellName()
{
    switch (Language)
    {
        case "Deutsch":
...
private static string LegionofSouls_SpellName()
{
    ...
    private static string DrumsofDeathlyFerocity_BloodlustEffectName()
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Unholy Deathknight", Color.Purple);
            ...
            //SpellCasts.Add(SpellId, Example_SpellName());
                ...
                SpellCasts.Add(275699 , Apocalypse_SpellName());// //275699
                SpellCasts.Add(42650 , ArmyOfTheDead_SpellName());// //42650
                SpellCasts.Add(45524 , ChainsOfIce_SpellName());//45524
                SpellCasts.Add(207311 , ClawingShadows_SpellName());// //207311
                SpellCasts.Add(56222 , DarkCommand_SpellName());//56222
                SpellCasts.Add(63560 , DarkTransformation_SpellName());// //63560
                ...
                SpellCasts.Add(48265 , DeathsAdvance_SpellName());//48265
                SpellCasts.Add(152280 , Defile_SpellName());//152280
                SpellCasts.Add(47568 , EmpowerRuneWeapon_SpellName());//47568
                SpellCasts.Add(207317 , Epidemic_SpellName());// //207317
                SpellCasts.Add(85948 , FesteringStrike_SpellName());// //85948
                SpellCasts.Add(48792 , IceboundFortitude_SpellName());//48792
                SpellCasts.Add(49039 , Lichborne_SpellName());//49039
                SpellCasts.Add(77575 , Outbreak_SpellName());// //77575
                SpellCasts.Add(61999 , RaiseAlly_SpellName());//61999
                SpellCasts.Add(46584 , RaiseDead_SpellName());//46584
                SpellCasts.Add(46585 , RaiseDead_SpellName());//46585
                SpellCasts.Add(327574 , SacrificialPact_SpellName());//327574
                SpellCasts.Add(55090 , ScourgeStrike_SpellName());// //55090
                SpellCasts.Add(343294 , SoulReaper_SpellName());//343294
                SpellCasts.Add(49206 , SummonGargoyle_SpellName());// //49206
                SpellCasts.Add(207289 , UnholyAssault_SpellName());// //207289
                SpellCasts.Add(115989 , UnholyBlight_SpellName());// //115989
                SpellCasts.Add(390279 , VileContagion_SpellName());// //390279
                SpellCasts.Add(212552 , WraithWalk_SpellName());//212552
                SpellCasts.Add(455395 , RaiseAbomination_SpellName());//455395
                SpellCasts.Add(265221 , Fireblood_SpellName());//265221
                SpellCasts.Add(458128 , FesteringScythe_SpellName());//458128
                SpellCasts.Add(473402 , Cheating_SpellName());//473402
                SpellCasts.Add(312411 , BagOfTricks_SpellName());//312411
                SpellCasts.Add(50613 , ArcaneTorrent_SpellName());//50613
                SpellCasts.Add(260364 , ArcanePulse_SpellName());//260364
                SpellCasts.Add(274738 , AncestralCall_SpellName());//274738
            ...
            PlayerQueues = new List<string>(){
                ...
                RaiseAbomination_SpellName(),
                DeathPact_SpellName(),
                DeathsAdvance_SpellName(),
                IceboundFortitude_SpellName(),
                SacrificialPact_SpellName(),
                Defile_SpellName(),
                Lichborne_SpellName(),
                BlindingSleet_SpellName(),
                DarkTransformation_SpellName()
            };
            ...
            TargetQueues = new List<string>(){
                DeathGrip_SpellName(),
               VampiricStrike_SpellName(),
                MindFreeze_SpellName(),
                Asphyxiate_SpellName(),
                ChainsOfIce_SpellName(),
                DeathCoil_SpellName(),
                FesteringStrike_SpellName(),
                RaiseAlly_SpellName(),
                UnholyAssault_SpellName()
