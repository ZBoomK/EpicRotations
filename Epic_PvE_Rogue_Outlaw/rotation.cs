        ...
        private static string InvigoratingHealingPotion_ItemName()
{
    switch (Language)
    {
        ...
        private static string AdrenalineRush_SpellName()
        {
            switch (Language)
            {
        ...
        private static string AzeriteSurge_SpellName()
{
    switch (Language)
    {
        ...
        private static string BetweenTheEyes_SpellName()
        {
            switch (Language)
            {
        ...
        private static string BladeFlurry_SpellName()
        {
            switch (Language)
            {
        ...
        private static string BladeRush_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Dispatch_SpellName()
        {
            switch (Language)
            {
        ...
        private static string Dreadblades_SpellName()
        {
            switch (Language)
            {
        ...
        private static string GhostlyStrike_SpellName()
        {
            switch (Language)
            {
        ...
        private static string GrapplingHook_SpellName()
        {
            switch (Language)
            {
        ...
        private static string KeepItRolling_SpellName()
        {
            switch (Language)
            {
        ...
        private static string KillingSpree_SpellName()
        {
            switch (Language)
            {
        ...
        private static string PistolShot_SpellName()
        {
            switch (Language)
            {
        ...
        private static string RollTheBones_SpellName()
        {
            switch (Language)
            {
        ...
        private static string SinisterStrike_SpellName()
        {
            switch (Language)
            {
        ...
        private static string AmplifyingPoison_SpellName()//381664
            ...
            private static string Riposte_SpellName()
            {
                switch (Language)
                {
                    case "Deutsch":
                    ...
                    case "Français":
                        return "Riposte";
                    case "Italiano":
                        return "Replica Immediata";
                    case "Português Brasileiro":
                        return "Ripostar";
                    case "Русский":
                        return "Отражение ударов";
                    case "한국어":
                        return "반격";
                    case "简体中文":
                        return "还击";
...
private static string DemonicHealthstone_ItemlName()
{
    ...
    private static string DrumsofDeathlyFerocity_BloodlustEffectName()
    {
        ...
        public override void Initialize(){
            ...
            Inferno.PrintMessage("Epic Rotations Rogue Outlaw", Color.Purple);
            ...
            //SpellCasts.Add(SpellId, Example_SpellName());
                ...
                SpellCasts.Add(456330, ColdBlood_SpellName()); //456330
                ...
                SpellCasts.Add(13750, AdrenalineRush_SpellName()); //13750
                SpellCasts.Add(315341, BetweenTheEyes_SpellName()); //315341
                SpellCasts.Add(13877, BladeFlurry_SpellName()); //13877
                SpellCasts.Add(271877, BladeRush_SpellName()); //271877
                SpellCasts.Add(2098, Dispatch_SpellName()); //2098
                SpellCasts.Add(441776, Dispatch_SpellName()); //441776
                SpellCasts.Add(467059, Dispatch_SpellName()); //467059
                SpellCasts.Add(343142, Dreadblades_SpellName()); //343142
                SpellCasts.Add(196937, GhostlyStrike_SpellName()); //196937
                SpellCasts.Add(195457, GrapplingHook_SpellName()); //195457
                SpellCasts.Add(381989, KeepItRolling_SpellName()); //381989
                SpellCasts.Add(51690, KillingSpree_SpellName()); //51690
                SpellCasts.Add(185763, PistolShot_SpellName()); //185763
                SpellCasts.Add(315508, RollTheBones_SpellName()); //315508
                SpellCasts.Add(193315, SinisterStrike_SpellName()); //193315
            ...
            PlayerQueues = new List<string>(){
                ...
                ColdBlood_SpellName(),
                Riposte_SpellName(),
                RollTheBones_SpellName(),
                BladeFlurry_SpellName(),
                AdrenalineRush_SpellName()
            };
            ...
            TargetQueues = new List<string>(){
                ...
                Sap_SpellName(),
                Shadowstep_SpellName(),
                KillingSpree_SpellName(),
                BetweenTheEyes_SpellName(),
                BladeFlurry_SpellName(),
                GhostlyStrike_SpellName()
